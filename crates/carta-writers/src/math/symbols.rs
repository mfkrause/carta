...
const fn ord(text: &'static str) -> Symbol {
    Symbol {
        text,
        class: Class::Ord,
        italic: false,
...
const fn bin(text: &'static str) -> Symbol {
    Symbol {
        text,
        class: Class::Bin,
        italic: false,
...
const fn rel(text: &'static str) -> Symbol {
    Symbol {
        text,
        class: Class::Rel,
        italic: false,
...
const fn open(text: &'static str) -> Symbol {
    Symbol {
        text,
        class: Class::Open,
        italic: false,
...
const fn close(text: &'static str) -> Symbol {
    Symbol {
        text,
        class: Class::Close,
        italic: false,
...
const fn punct(text: &'static str) -> Symbol {
    Symbol {
        text,
        class: Class::Punct,
        italic: false,
...
const fn op(text: &'static str) -> Symbol {
    Symbol {
        text,
        class: Class::Op,
        italic: false,
...
pub(super) fn symbol(name: &str) -> Option<Symbol> {
    let s = match name {
        "Bbbk" => var("\u{1D55C}"),
        "Aries" => ord("\u{2648}"),
        "Box" => ord("\u{25A1}"),
