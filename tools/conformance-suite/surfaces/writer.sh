...
TARGETS="html html4 latex rst plain commonmark commonmark_x markdown markdown_github markdown_phpextra gfm mediawiki native json typst dokuwiki jira asciidoc man opml beamer revealjs"
[ $# -gt 0 ] && TARGETS="$1"
